...
import com.example.project_1201345_12012093.OrderDetailsDialogManager;
...
public class PizzaOrdersAdapter extends ArrayAdapter<Order> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        if (convertView == null)
            convertView = LayoutInflater.from(context).inflate(R.layout.order_items, parent, false);
